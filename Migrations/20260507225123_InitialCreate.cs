        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imagen = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionEnvio = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagenesAdicionales = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ...
                    Tallas = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Colores = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Activo = table.Column<bool>(type: "boolean", nullable: false),
                    Destacado = table.Column<bool>(type: "boolean", nullable: false),
                    EsNuevo = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Talla = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "Activa", "Descripcion", "Imagen", "Nombre", "Orden", "Slug" },
                values: new object[,]
                {
                    { 1, true, "Los mejores tenis y sneakers de las mejores marcas", null, "Tenis & Sneakers", 1, "tenis-sneakers" },
                    { 2, true, "Ropa urbana y de lifestyle", null, "Ropa", 2, "ropa" },
                    { 3, true, "Fragancias exclusivas", null, "Perfumes", 3, "perfumes" },
                    { 4, true, "Gorras y sombreros de moda", null, "Gorras", 4, "gorras" },
                    { 5, true, "Bolsos y mochilas de diseñador", null, "Bolsos", 5, "bolsos" },
                    { 6, true, "Lentes de sol y ópticos", null, "Lentes", 6, "lentes" },
                    { 7, true, "Accesorios de moda y lifestyle", null, "Accesorios", 7, "accesorios" }
                });
